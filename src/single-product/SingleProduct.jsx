...
import AlsoPurchased from "./AlsoPurchased.jsx";
...
import ShopByCates from "./ShopByCates.jsx";
...
const SingleProduct = ()=>
{
    ...
    return(
        <main className="  mx-auto sm:pt-16 sm:px-6 lg:px-8">
            <div className="sm:w-11/12 max-w-7xl mx-auto lg:max-w-none">
                {/* Product */}
                <div className="flex flex-col  justify-center items-center">
                    <div className="max-w-7xl lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
                        {/* Image gallery */}
                ...
                <section aria-labelledby="related-heading" className="mt-0 border-t border-gray-200 py-1 px-4 sm:px-0">
                    <AlsoPurchased/>
                    <Reviews id={id} singleProduct={singleProduct} />
                    <ShopByCates/>
                    <Policies/>
                </section>
            </div>
