...
export default function CheckOut()
{
    return (
        <>
            <main className="lg:min-h-full lg:flex lg:flex-row-reverse">
                <div className="px-4 py-6 sm:px-6 lg:hidden">
                    <div className="max-w-lg mx-auto flex">
                        <a href="#">
                            <span className="text-2xl">Mude Checkout</span>
                        </a>
                    </div>
                </div>
                ...
                <section
                    ...
                    className="flex-auto bg-gray-50 overflow-y-auto px-4 pt-12 pb-16 sm:px-6 sm:pt-16 lg:px-8 lg:pt-0 lg:pb-24"
                >
                    <div className="max-w-lg mx-auto">
                        ...
                        <form className="mt-6">
                            ...
                            <p className="flex justify-center text-sm font-medium text-gray-500 mt-6">
                                <FcLock className="w-5 h-5 text-gray-400 mr-1.5" aria-hidden="true" />
