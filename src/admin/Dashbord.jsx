...
const navigation = [
    ...
    { name: 'Balances', href: '#', icon: AiOutlineBell, current: false },
    { name: 'Cards', href: '#', icon: AiOutlineBell, current: false },
    { name: 'Recipients', href: '#', icon: AiOutlineBell, current: false },
    { name: 'Reports', href: '#', icon: AiOutlineBell, current: false },
]
const secondaryNavigation = [
    { name: 'Settings', href: '#', icon: AiOutlineBell },
    { name: 'Help', href: '#', icon: AiOutlineBell },
    { name: 'Privacy', href: '#', icon: AiOutlineBell },
]
const cards = [
    { name: 'Account balance', href: '#', icon: AiOutlineBell, amount: '$30,659.45' },
    // More items...
]
const transactions = [
    {
                                ...
                                >
                                    <div className="absolute top-0 right-0 -mr-12 pt-2">
                                        ...
                                        >
                                            ...
                                            <AiOutlinePlus className="h-6 w-6 text-white rotate-45" aria-hidden="true" />
                                        </button>
                                    </div>
                                </Transition.Child>
                    ...
                    <main className="flex-1 pb-8">
                        ...
                        <span className="flex items-center space-x-4">
                          <span className="flex-1 flex space-x-2 truncate">
                            <SiBitcoincash className="flex-shrink-0 h-5 w-5 text-gray-400" aria-hidden="true" />
                          ...
                          <AiOutlineArrowRight className="flex-shrink-0 h-5 w-5 text-gray-400" aria-hidden="true" />
                        </span>
                                            </a>
                                        </li>
                                    ))}
